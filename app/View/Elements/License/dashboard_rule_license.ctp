<?php if ($this->request->ext != 'ajax' && AuthComponent::user() && in_array(AuthComponent::user('AccountType.name'), ['Subcontractor', 'Supervisor'])): ?>
    <h5 class="ml-5 mb-3 text-uppercase bg-light p-2" style="width: fit-content;">
