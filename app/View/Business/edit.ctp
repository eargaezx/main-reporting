<div class="card ">
    ...
    <div class="card-block p-4">
        ...
        if (is_array($this->request->data['Employee']) && !array_diff_key($this->request->data['Employee'], array_keys(array_keys($this->request->data['Employee'])))) {
            $this->request->data['Employee'] = $this->request->data['Employee'][0];
        }

        $this->request->data['Account'] = $this->request->data['Employee']['Account'];
        ...
        $modelFields['Business.logo']['required'] = false;
        $modelFields['Business.logo']['data-default-file'] = $this->request->data['Business']['logo'];
...
// src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAYzR1KKoa1Rwkp-aoCgfQiv7wlcCvyNwk&libraries=places">
    ...
    function initAutocomplete() {
        ...
        const latitude = document.getElementById("BusinessLocationLatitude").value;
        const longitude = document.getElementById("BusinessLocationLongitude").value;
