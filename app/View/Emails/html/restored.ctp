<?= $this->set('preheader', 'Hola '.(isset($name)?$name:'').' recientemente hemos detectado que recuperaste tu cuenta Plataforma Garden. Si no reconoces esta recuperación de cuenta, contactanos en nuestra pagina web, simplemente presionando el botón de abajo.') ?>
<tr>
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%"  >
            ...
            <tr>
                <td bgcolor="#ffffff" align="left" style="padding: 20px 30px 40px 30px; color: #666666; font-family: 'Lato', Helvetica, Arial, sans-serif; font-size: 18px; font-weight: 400; line-height: 25px;" >
                    <p style="margin: 0;">
                        <span>
                           Hola <?= isset($name)?$name:'' ?> recientemente hemos detectado que recuperaste tu cuenta Plataforma Garden.
                        </span>
                    </p>
                </td>
            </tr>
            ...
            <tr>
                <td bgcolor="#ffffff" align="left" style="padding: 0px 30px 40px 30px; color: #666666; font-family: 'Lato', Helvetica, Arial, sans-serif; font-size: 18px; font-weight: 400; line-height: 25px;" >
                    <p style="margin: 0;">
                        <span>
                            Si no reconoces esta recuperación de cuenta, contactanos en nuestra pagina web, simplemente presionando el botón de abajo.
                        </span>
                    </p>
                </td>
            </tr>
